...
import { AppHeader, Button, Chip, Counter, SegmentedControl } from '../components';
import { formatPrice } from '../data/format';
import { describeSelections, findDish, resolveDishPrice } from '../data/menuRepository';
import { countShared, splitTotals, type SplitLine } from '../data/split';
import { pluralGuests } from '../data/plural';
import type { SplitMode, SplitState } from '../data/types';
