...
import { AppHeader, CartBar, Chip, DishCard, IconButton, SearchField, ShoppingBagIcon, ts } from '@food/ui';
import { dishImage, formatMeta, formatTableLabel, getMenu, isAvailable, resolveDishPrice } from '../data/menuRepository';
import { formatPrice, type Menu, pluralItems } from '@food/domain';
