...
из домена, а не отдельная сущность экрана. Тикет двигают кнопкой, не перетаскиванием: у повара
мокрые руки, и drag-and-drop на стене промахивается. В «Готово» тикет ждёт официанта — оттуда
